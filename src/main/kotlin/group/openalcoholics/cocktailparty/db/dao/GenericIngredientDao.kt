...
interface GenericIngredientDao : SqlObject, BaseDao<GenericIngredient> {
    /**
     ...
     */
    fun search(query: String?, limit: Int, offset: Int): List<GenericIngredient> = handle
        .createQuery("""
        ...
        .mapTo(GenericIngredient::class.java)
        .list()

    companion object : BaseDaoCompanion {
        const val TABLE_NAME = "generic_ingredient"
